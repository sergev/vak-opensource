...
# Switches.
set_instance_assignment -name IO_STANDARD "3.0-V LVTTL" -to switch[0]
set_instance_assignment -name IO_STANDARD "3.0-V LVTTL" -to switch[1]
set_instance_assignment -name IO_STANDARD "3.0-V LVTTL" -to switch[2]
set_instance_assignment -name IO_STANDARD "3.0-V LVTTL" -to switch[3]
set_instance_assignment -name IO_STANDARD "3.0-V LVTTL" -to switch[4]
set_instance_assignment -name IO_STANDARD "3.0-V LVTTL" -to switch[5]
set_instance_assignment -name IO_STANDARD "3.0-V LVTTL" -to switch[6]
set_instance_assignment -name IO_STANDARD "3.0-V LVTTL" -to switch[7]
set_instance_assignment -name IO_STANDARD "3.0-V LVTTL" -to switch[8]
set_instance_assignment -name IO_STANDARD "3.0-V LVTTL" -to switch[9]
