 ...
 *      Редактор RED.
 *
 *      $Header: U.locl.h,v 4.20 90/05/22 23:21:34 alex Exp $
 *      $Log:   U.locl.h,v $
 * Revision 4.20  90/05/22  23:21:34  alex
 * First rev. red 4.2
 * 
 * Revision 4.10  90/02/05  19:52:15  alex
 * Base revision 4.1
 * 
 * Revision 4.1  88/03/31  22:00:23  alex
 * Версия 4.1 - обкатка на UTEC, СМ
 * 
 * Revision 3.1.2.1  87/06/22  16:15:11  alex
 * *** empty log message ***
 * 
 * Revision 3.1  87/06/22  16:14:44  alex
 * *** empty log message ***
 * 
 * Revision 1.3  87/06/05  23:48:47  alex
 * Добавлен roll для терминалов с sr/sf и отображение
 *  табуляций в режиме -t + всякая мелочь
 * 
 * Revision 1.2  87/04/01  19:14:37  alex
 * Revision for Utec: Cs, Ce, Ct, hR
 * 
 * Revision 1.1  87/03/23  11:03:59  alex
 * Initial revision
 * 
...
#define LATFLG(x) 1 /* пУЦТБ ВЫДАУТЦЯ КАК МОГУТ ╙╞
