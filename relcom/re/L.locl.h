 ...
 *      Редактор RED.
 *
 *      $Header: L.locl.h,v 4.20 90/05/22 23:23:30 alex Exp $
 *      $Log:   L.locl.h,v $
 * Revision 4.20  90/05/22  23:23:30  alex
 * *** empty log message ***
 * 
...
/*******************************
 *  Описания для SYSTEM-V/Labtam/Xenix/IX
 *******************************
 */

/* #define DEBUG        */
#define SWORD (sizeof (int))
#define TERMIO                  /* Работать через вызов TERMIO */
#define RED_CYRILL              /* Работать с русскими самому  *ю
#define NO_AOUT                 /* Таблицы кодов записаны без заголовка */
#define NO_200                  /* Не использовать коды 200 для задержек*/
#define LATFLG(ttyio)   1
#define KIOFLG(ttyio)   0
#define LCASEF(ttyio)   ((ttyio.c_oflag & OLCUC) != 0)
#define MAXFILES 26
#define MAXPORTLIST 20
