...
===============
  ...
  *Report bugs.
  ...
  For any case:
  Send a mail to pintocar83@gmail.com with the modifications and information: Email, Autor and
changes. Thanks!!!
...
public:
    ...
    int gettext(int l, int t, int r, int b, void *destination) { return 0; }
