...
151 RETURN
160 HOME
164 PRINT TAB(12);"INSPECTOR CLEW-SO"
166 PRINT
167 PRINT TAB( 13);"BY RON CARLSON"
170 PRINT TAB( 9);"ADAPTED BY DONALD BROWN"
171 PRINT
172 PRINT
210 PRINT "BILL, MARY, JOHN, SUZY AND PAUL ARE"
211 PRINT "HOUSE GUESTS. THEIR HOST WAS MURDERED"
212 PRINT "BY ONE OF THEM BETWEEN 1 PM. AND 9 PM."
220 PRINT "YOUR JOB AS INSPECTOR CLEW-SO IS TO FIND";
221 PRINT "THE KILLER, TIME, AND ROOM. YOU WILL"
222 PRINT "BE GIVEN A HOUSE DIAGRAM AND A SET OF"
230 PRINT "QUESTIONS FOR THE SUSPECTS, BUT THE"
231 PRINT "GUILTY PERSON MAY TRY TO MISLEAD YOU BY"
232 PRINT "LYING SOME OF THE TIME."
240 PRINT "IF ONE OF THE SUSPECTS CLAIM THAT THE"
241 PRINT "HOST WAS ALREADY DEAD OR THAT THE HOST"
242 PRINT "WAS STILL ALIVE, THEN YOU HAVE FOUND THE";
243 PRINT "ROOM WHERE THE MURDER TOOK PLACE."
244 PRINT
250 PRINT
251 INPUT "(HIT ANY KEY TO CONTINUE)",A$
253 PRINT
254 HOME
...
340 PRINT "  !--------!---------!-----!"
350 PRINT
362 PRINT TAB(33);"SUSPECTS"
363 FOR AA = 1 TO 5
365 PRINT TAB(35);S$(AA)
366 NEXT
400 HOME
460 FOR K = 1 TO 5
...
582 R = P(M,T)
610 PRINT
611 PRINT "INSPECTOR CLEW-SO, WHO DO YOU WANT TO"
612 INPUT " QUESTION? ",S1$
...
623 IF S = 0 THEN 610
630 HOME
640 PRINT "DO YOU WISH TO QUESTION ";S$(S)
641 PRINT "ABOUT--"
642 PRINT " 1 - WHEREABOUTS AT PARTICULAR TIME"
643 PRINT " 2 - TIME SUSPECT IN CERTAIN ROOM"
...
1610 FOR V1 = 1 TO 9000
1611 NEXT
1612 PRINT
1613 PRINT CHR$(4)"-STARTUP"
