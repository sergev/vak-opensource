...
**
**      And for final all the messages was translated into Russian by @VG.
**              Also code was modifyed for non-portable C compiler to
**              compile it for CM-4.
**
**********************************************************************
**
...
**      we don't have FLOAT ing point hardware here; even if we did, I
...
**      implementations, and because I was too lazy to do the FLOAT ing
