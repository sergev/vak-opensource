...
void clear ()		/* table clear for block compress */
{
    register code_int i;
...
/* clear hash cache */
void creset (register count_int n)	/* clear at least this many entries */
{
...
int hogtally ()	/* compute character code hog */
{
    register int i, most;
