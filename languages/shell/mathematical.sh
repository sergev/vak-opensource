...
# Function to print a block of characters in 8 columns, 16 rows
print_block() {
    local start=$1
    local end=$(($2 - 1))
...
echo "Mathematical Symbols (U+2200 to U+22FF)"
echo
print_block 0x2200 0x2280
print_block 0x2280 0x2300
