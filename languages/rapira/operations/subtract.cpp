...
/*** Constructor ***/
Subtract::Subtract(Object* pArg1, Object* pArg2)
{
	setArgument1(pArg1);
	setArgument2(pArg2);
}
...
unsigned char Subtract::getType()
{
	return OP_SUBTRACT;
}

/*** Set the first argument ***/
void Subtract::setArgument1(Object* pArg)
{
	arg1 = pArg;
}

/*** Set the second argument ***/
void Subtract::setArgument2(Object* pArg)
{
	arg2 = pArg;
}

/*** Evaluate this object ***/
Object* Subtract::evaluate()
{
	if(arg1 == 0)
