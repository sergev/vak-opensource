...
class Subtract : public Object
{
	...
	public:
		...
		/*** Constructor ***/
		Subtract(Object* pArg1, Object* pArg2);
		...
		{
			Subtract* csn = new Subtract();
			csn->setLineNumber(getLineNumber());
			csn->setColumnNumber(getColumnNumber());
			if(arg1 != 0)
				csn->setArgument1(arg1->clone());
			if(arg2 != 0)
				csn->setArgument2(arg2->clone());
			return csn;
		}
