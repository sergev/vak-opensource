...
class InvalidIndexException : public Excep
{

	public:

		/*** Constructor ***/
		InvalidIndexException(unsigned int pLineNum, unsigned int pColNum, long pValue);

		/*** Constructor ***/
		InvalidIndexException(unsigned int pLineNum, unsigned int pColNum, long pValue, unsigned char pArgNum);
