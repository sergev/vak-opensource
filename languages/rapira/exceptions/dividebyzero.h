...
class DivideByZeroException : public Excep
{

	public:

		/*** Constructor ***/
		DivideByZeroException(unsigned int pLineNum, unsigned int pColNum);

		/*** Constructor ***/
		DivideByZeroException(unsigned int pLineNum, unsigned int pColNum, unsigned char pArgNum);
