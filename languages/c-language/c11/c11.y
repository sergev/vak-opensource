...
// ANSI C Yacc grammar
// ~~~~~~~~~~~~~~~~~~~
// From: https://www.quut.com/c/ANSI-C-grammar-y-2011.html
// (This Yacc file is accompanied by a matching Lex file.)
//
// In 1985, Jeff Lee published his Yacc grammar based on a draft
// version of the ANSI C standard, along with a supporting Lex specification.
...
// (The previous version's Lex and Yacc files for ANSI C9X still exist
// as archived copies.)
//
...
// literals will perform concatenation (translation phase 6).
// Transliteration of universal character names (\uHHHH or \UHHHHHHHH)
// must have been done by either the preprocessor or a replacement
// for the input() macro used by Lex (or the YY_INPUT function used by Flex)
// to read characters. Although comments should have been changed to space
// characters during translation phase 3, there are Lex rules for them anyway.
//
