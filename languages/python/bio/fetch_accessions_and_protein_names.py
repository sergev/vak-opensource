...
def fetch_accessions_and_protein_names(db="nucleotide", query="human[Organism]", max_results=1000):
    """
...
# Example: Fetch accession numbers and protein names for human insulin sequences
