 ...
 *
 * Copyright (C) 2015-2018 Serge Vakulenko
 *
...
/*
 * Signal assignment.
 * LED module is connected to pins D2,D3,D4 of Arduino Nano board.
 *
 * Nano     LED module
 * -------------------
 *  D2          CS
 ...
 *  D4          DATA
 */
#define gpio_cs_clear()     digitalWrite(2, LOW)
#define gpio_cs_set()       digitalWrite(2, HIGH)
#define gpio_wr_clear()     digitalWrite(3, LOW)
#define gpio_wr_set()       digitalWrite(3, HIGH)
#define gpio_data_clear()   digitalWrite(4, LOW)
#define gpio_data_set()     digitalWrite(4, HIGH)
...
void lcd_init()
{
    /* Configure pins D0-D2 as outputs. */
    pinMode(2, OUTPUT);
    pinMode(3, OUTPUT);
    pinMode(4, OUTPUT);
    gpio_cs_set();
...
void setup()
{
    ...
    for (unsigned i=0; i<sizeof(char_to_segm); i++) {
