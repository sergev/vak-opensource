...
/*
 * Wait for PMP cycle end.
 */
#define PMPWaitBusy()       while(PMMODEbits.BUSY)

/*
 * SS line to access a control register space.
 */
...
/*
 * Set RS line to access a data space.
 */
...
/*
 * Put the chip select line in inactive state.
 */
...
/*
 * Write data into controller's RAM.
...
/*
 * Read data from controller's RAM.
 * Output: data read.
 * Note: chip select should be enabled.
 */
