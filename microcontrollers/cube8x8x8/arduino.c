...
void setup()
{
    ...
    // pinMode(A0, OUTPUT) as specified in the arduino reference didn't work.
    // So I accessed the registers directly.
    DDRC = 0xff;
    PORTC = 0x00;
...
const int charNum = 34;
char string[charNum] = {'S','U','P','E','R','T','E','C','H','-','I','T',' ','D','O','T',' ','C','O','M',' ','I','N','S','T','R','U','C','T','A','B','L','E','S'};
