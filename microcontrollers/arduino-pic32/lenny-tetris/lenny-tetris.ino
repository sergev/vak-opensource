...
int joystick_get()
{
    ...
    if      (input > 882)  button = JOYSTICK_NONE;
    else if (input > 624)  button = JOYSTICK_UP;
    else if (input > 424)  button = JOYSTICK_RIGHT;
    else if (input > 242)  button = JOYSTICK_DOWN;
    else if (input > 73)   button = JOYSTICK_SELECT;
